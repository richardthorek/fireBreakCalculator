/**
 * TEMPORARY DUPLICATE of `api/src/services/elevationService.ts` — api-mobility
 * is a standalone package until the OCOKA 5 `deployMobilityBackend` cutover
 * merges it into `/api` (see README.md). Keep in sync until then.
 *
